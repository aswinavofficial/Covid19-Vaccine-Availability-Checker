...
#Sending Mail for under 45 centers
if len(under_45_centers) > 0:
	htmlTable = json2html.convert(json = under_45_centers)
	print(send_mail("Vaccine Availability Notification - Under 45",htmlTable))
